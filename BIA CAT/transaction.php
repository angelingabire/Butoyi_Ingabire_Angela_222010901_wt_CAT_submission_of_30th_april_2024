...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="text" id="ttype" name="ttype" required><br><br>

        <label for="amount">amount:</label>
        <input type="number" id="tam" name="tam" required><br><br>

        <label for="transaction_date">transaction date:</label>
        <input type="date" id="tdate" name="tdate" required><br><br>

        <label for="account_id">Account id:</label>
        <input type="number" id="taid" name="taid" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO transaction(transaction_id, transaction_type,amount, transaction_date, account_id) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $transaction_id, $transaction_type, $amount, $transaction_date,$account_id);
    ...
    <table border="5">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $tid = $row['transaction_id']; // Fetch the Product_Id
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_transaction.php?transaction_id=$tid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_transaction.php?transaction_id=$tid'>Update</a></td> 
                </tr>";
            }
        } else {
