...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <input type="number" id="ephoneno" name="ephoneno" required><br><br>

        <label for="customer_id">customer id:</label>
        <input type="number" id="ecid" name="ecid" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO employee(employee_id,employee_name,email,phone_number, customer_id) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $employee_id, $employee_name, $email, $phone_number,$customer_id);
